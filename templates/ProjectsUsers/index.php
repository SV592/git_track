        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="actions">
                        <?= $this->Html->link(__('View'), ['action' => 'view', $projectsUser->project_id]) ?>
                        <?= $this->Html->link(__('Edit'), ['action' => 'edit', $projectsUser->project_id]) ?>
                        <?= $this->Form->postLink(
                            __('Delete'),
                            ['action' => 'delete', $projectsUser->project_id],
                            [
                                'method' => 'delete',
                                'confirm' => __('Are you sure you want to delete # {0}?', $projectsUser->project_id),
                            ]
                        ) ?>
                    </td>
                </tr>
